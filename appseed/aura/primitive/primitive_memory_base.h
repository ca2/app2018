...
namespace primitive
{
   ...
   public:
      ...
      {
         return (const char *) operator const byte *();
      }
      ...
      void to_base64(string & str, memory_position_t iStart = 0, memory_size_t size = -1);
      string to_base64(memory_position_t iStart = 0, memory_size_t size = -1);
