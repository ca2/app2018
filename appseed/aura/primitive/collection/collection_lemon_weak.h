...
namespace lemon
{
   ...
   namespace weak
   {
      ...
      namespace map
      {
         ...
         template < typename MAP >
         typename MAP::BASE_VALUE value(MAP & m, typename MAP::BASE_ARG_KEY key, typename MAP::BASE_VALUE default_value = ::lemon::weak::default_value < typename MAP::BASE_VALUE >())
         {
