...
//
//
//void stringa::add_lines(const string & str,bool bAddEmpty)
//{
//
//   strsize iPos = 0;
//
...
//      {
//
//         add(string(&str[iPos],iFind1 - iPos));
//
//      }
//      else if(bAddEmpty)
//      {
...
//      {
//
//         add(string(&str[iPos],iFindA - iPos));
//
//      }
//      else if(bAddEmpty)
//      {
...
//   {
//
//      add(string(&str[iPos],str.get_length() - iPos));
//
//   }
//   else if(bAddEmpty)
//   {
