...
//#ifdef __GNUC__
   ...
   // replace all occurrences of string 'pszOld' with string 'pszNew'
   ::count replace_count(const char * pszOld, const char * pszNew, strsize iStart = 0);

   ::count replace_ci_count(const char * pszOld, const char * pszNew, strsize iStart = 0);
   ...
   bool eat_before(string & strBefore, string strSeparator, bool bEatEverythingIfNotFound = false);
   bool eat_before_let_separator(string & strBefore, string strSeparator, bool bEatEverythingIfNotFound = false);
   ...
   bool equals_ci(const char * psz) const;
