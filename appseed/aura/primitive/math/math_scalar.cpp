...
//
//
//void int_scalar_source::listener::on_set_scalar(int_scalar_source * psource,e_scalar escalar,int64_t iValue,int iFlags)
//{
//
//   UNREFERENCED_PARAMETER(psource);
//   UNREFERENCED_PARAMETER(escalar);
...
//
//
//bool int_scalar_source::set_scalar(e_scalar escalar,int64_t iValue,bool bForce,int iFlags)
//{
//
//   if (!bForce)
//   {
...
//
//
//void int_scalar_source::on_set_scalar(e_scalar escalar,int64_t iValue,int iFlags)
//{
//   
//   UNREFERENCED_PARAMETER(escalar);
//   
...
//   int64_t iDenominator = iMax - iMin;
//
//   on_set_scalar(escalar,(int64_t) round(dValue * iDenominator) + iMin, iFlags);
//
//   return true;
//
//}
