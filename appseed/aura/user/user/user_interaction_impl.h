...
namespace user
{
   ...
   public:
      ...
      virtual void deferred_on_change_visibility() override;
      ...
      virtual bool create_window_ex(::user::interaction * pui, ::user::create_struct & cs, ::user::interaction * pParentWnd, id id) override;
