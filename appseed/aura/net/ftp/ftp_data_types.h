...
namespace ftp
{
   ...
   /// Transmission Modes
   class CLASS_DECL_AURA transfer_mode
   {
   public:
   ...
   /// Firewall Type
   class CLASS_DECL_AURA firewall_type
   {
   public:
   ...
   class CLASS_DECL_AURA representation :
