...
namespace ftp
{
   ...
   /// - ...
   ///
   class CLASS_DECL_AURA client_socket :
   ...
   public:
      ...
      bool List(const string& strPath, stringa& vstrFileList, bool fPasv = false);
      bool NameList(const string& strPath, stringa& vstrFileList, bool fPasv = false);
      ...
      bool SendCommand(const command& Command, const stringa & Arguments);
   ...
   public:
      ...
      virtual void OnSendCommand(const command& /*Command*/, const stringa& /*Arguments*/) {}
