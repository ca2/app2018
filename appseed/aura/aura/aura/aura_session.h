...
namespace aura
{
   ...
   public:
      ...
      virtual bool set_cursor(::user::interaction * pui, ::visual::cursor * pcursor);
      virtual bool set_cursor(::user::interaction * pui, ::visual::e_cursor ecursor);
      virtual bool set_default_cursor(::user::interaction * pui, ::visual::e_cursor ecursor);
      virtual ::visual::cursor * get_cursor();
      virtual ::visual::cursor * get_default_cursor();
