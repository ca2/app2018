...
#include "framework.h"
//#include "metrowin.h"
//void file_read_ex1_string_dup(HANDLE hfile, ::aura::md5 * pctx, string & str);
//void file_read_n_number_dup(HANDLE hfile, ::aura::md5 * pctx, int32_t & iNumber);
////
////
////
////
...
//         string strPath = ::file::path(pszDir)/ strRelative;
