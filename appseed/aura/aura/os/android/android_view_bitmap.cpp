...
void android_fill_plasma(AndroidBitmapInfo * info, void * pixels, double  t)
{
   ...
   if (::aura::system::g_p->m_psystem->m_possystemwindow->m_pui.is_null())
   {
   ...
   if (::aura::system::g_p->m_psystem->m_possystemwindow->m_pui->m_pimpl == NULL)
   {
   ...
   if (::aura::system::g_p->m_psystem->m_possystemwindow->m_pui->m_pimpl->get_window_graphics() == NULL)
   {
   ...
   auto pbuffer = dynamic_cast <::window_double_buffer *> (::aura::system::g_p->m_psystem->m_possystemwindow->m_pui->m_pimpl->get_window_graphics());
