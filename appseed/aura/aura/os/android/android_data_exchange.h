...
typedef void FN_native_activity_android_start(node_data_exchange * pinitdata);
typedef FN_native_activity_android_start * PFN_native_activity_android_start;

typedef void FN_native_activity_android_end();
typedef FN_native_activity_android_end * PFN_native_activity_android_end;
