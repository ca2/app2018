...
namespace message
{
   ...
   void sender::send_message(::message::message * pmessage)
   {

      pmessage->m_psender = this;

      peceiver->route_message(pmessage);
   ...
   void sender::remove_receiver(::message::receiver * preceiver)
   {
      ...
      for (auto & receiver_route_array : m_map)
      {

         receiver_route_array.m_element2.remove_key(preceiver);
      }
...
////   }
//
//   sp(::message::data) dispatch::get_base(UINT uiMessage,WPARAM wparam,LPARAM lparam)
//   {
//
//      sp(::message::data) pbase;
//
...
//   }
//
//   sp(::message::data) dispatch::get_base(LPMESSAGE lpmsg)
//   {
//
...
//      {
//         
//         sp(::message::data) pbaseCast = pbase->m_lparam;
//         
