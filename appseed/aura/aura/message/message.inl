...
//////
//////
//////   inline void dispatch::message::senderArray::GetSignalsByMessage(dispatch::message::senderPtrArray & signalptra,UINT uiMessage,UINT uiCode,UINT uiId)
//////   {
...
//////      }
//////
//////   inline dispatch::message::sender * dispatch::message::senderArray::GetSignal(UINT uiMessage,UINT uiCode,UINT uiId,int & i)
//////   {
...
//////   }
//////
//////   inline dispatch::message::sender * dispatch::message::senderArray::
...
//////#define MSG_MOUSELEAVE     IGUI_MOUSELEAVE(this_class);
//////
...
//////   void class::install_message_routing(::message::sender * psender) \
//////{ \
//////   \
