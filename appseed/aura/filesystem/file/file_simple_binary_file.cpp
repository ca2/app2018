...
namespace file
{
   ...
   simple_binary_file::simple_binary_file(::aura::application * papp) :
      object(papp)
   {
   ...
   cres simple_binary_file::open(const ::file::path & lpszFileName, UINT nOpenFlags)
   {
   ...
   memory_size_t simple_binary_file::read(void * lpBuf, memory_size_t nCount)
   {
      ASSERT_VALID(this);
      ASSERT(m_pfile != NULL);
   ...
   void simple_binary_file::write(const void * lpBuf, memory_size_t nCount)
   {
      ASSERT_VALID(this);
      ASSERT(m_pfile != NULL);
   ...
   file_position_t simple_binary_file::seek(file_offset_t lOff, ::file::e_seek nFrom)
   {
      ASSERT_VALID(this);
   ...
   file_position_t simple_binary_file::get_position() const
   {
      ASSERT_VALID(this);
      ASSERT(m_pfile != NULL);
   ...
   ::file::file_sp  simple_binary_file::Duplicate() const
   {
      ASSERT_VALID(this);
      ASSERT(m_pfile != NULL);
   ...
   void simple_binary_file::LockRange(file_position_t /* dwPos */, file_size_t /* dwCount */)
   {
      ASSERT_VALID(this);
      ASSERT(m_pfile != NULL);
   ...
   file_size_t simple_binary_file::get_length() const
   {
      ASSERT_VALID(this);
