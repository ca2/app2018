...
CLASS_DECL_AURA bool file_put(const char * path, ::file::serializable & s, ::aura::application * papp)
{
   ...
   try
   {
      ...
      ::file::file_sp pfile = App(papp).file().get_file(path, ::file::mode_create | ::file::mode_write | ::file::type_binary | ::file::defer_create_directory | ::file::share_exclusive);
...
CLASS_DECL_AURA bool file_as(::file::serializable & s, const char * path, ::aura::application * papp)
{
   ...
   try
   {
      ...
      ::file::file_sp pfile = App(papp).file().get_file(path, ::file::mode_read | ::file::type_binary | ::file::share_deny_write);
