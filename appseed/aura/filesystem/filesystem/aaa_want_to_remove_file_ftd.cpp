...
//
//#ifdef WINDOWS
//CLASS_DECL_AXIS void file_read_n_number_dup(HANDLE hfile,MD5_CTX * pctx,int32_t & iNumber);
//CLASS_DECL_AXIS void file_read_gen_string_dup(HANDLE hfile,MD5_CTX * pctx,string & str);
//#else
//CLASS_DECL_AXIS void file_read_n_number_dup(FILE * hfile,MD5_CTX * pctx,int32_t & iNumber);
...
//
//
//void file_read_n_number_dup(HANDLE hfile,MD5_CTX * pctx,int32_t & iNumber)
//{
//
//   string str;
//
