...
public:
   ...
   C2PassScale (double dFilterWidth = -1.0, ProgressAnbAbortCallBack callback = NULL) :
...
UINT uOrigScan)
{
...

   {
      ...
      ::draw2d::copy_colorref(uOrigWidth, uOrigHeight, pOrig, uOrigWidth * sizeof(COLORREF), pOrigImage, uOrigScan);
...

   {
      ...
      ::draw2d::copy_colorref(uNewWidth, uNewHeight, pDstImage, uNewScan, pDest, uNewWidth * sizeof(COLORREF));
