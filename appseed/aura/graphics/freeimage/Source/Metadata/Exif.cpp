...
static short
ReadInt16(WINBOOL msb_order, const void *buffer)
{
   short value;
...
static LONG
ReadInt32(WINBOOL msb_order, const void *buffer)
{
   LONG value;
...
ReadUint16(WINBOOL msb_order, const void *buffer)
{
...
static DWORD
ReadUint32(WINBOOL msb_order, const void *buffer)
{
...
*/
static void
processIFDOffset(FITAG *tag, char *pval, WINBOOL msb_order, DWORD *subdirOffset, TagLib::MDMODEL *md_model)
{
   // get the IFD offset
...
*/
static void
processMakerNote(FIBITMAP *dib, char *pval, WINBOOL msb_order, DWORD *subdirOffset, TagLib::MDMODEL *md_model)
{
   FITAG *tagMake = NULL;
...
*/
static void
processExifTag(FIBITMAP *dib, FITAG *tag, char *pval, WINBOOL msb_order, TagLib::MDMODEL md_model)
{
   char defaultKey[16];
   int n;
   DWORD i;
...
*/
static WINBOOL
jpeg_read_exif_dir(FIBITMAP *dib, const BYTE *tiffp, unsigned long offset, unsigned int length, WINBOOL msb_order, TagLib::MDMODEL starting_md_model)
{
   WORD de, nde;
