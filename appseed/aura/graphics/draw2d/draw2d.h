...
namespace draw2d
{
   ...
   CLASS_DECL_AURA void vertical_swap_copy_colorref_swap_red_blue(int cx,int cy,COLORREF * pcolorrefDst,int iStrideDst,COLORREF * pcolorrefSrc,int iStrideSrc);
   ...
   CLASS_DECL_AURA void copy_colorref_swap_red_blue(int cx,int cy,COLORREF * pcolorrefDst,int iStrideDst,COLORREF * pcolorrefSrc,int iStrideSrc);
