...
//      HICON hicon16;
//      HICON hicon48;
      ::ca::window * pwnd = CaSys(pview).window_from_os_data(hwnd);
      if(pwnd == NULL)
         return TRUE;
...
//      HICON hicon48;
   ...
   view::task_array::task_array(::ca::application * papp) :
      ca(papp),
      thread(papp),
      simple_thread(papp)
   {
   ...
   bool view::task_array::initialize(::view * pview)
   {
