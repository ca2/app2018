...
public:
   ...
   virtual bool data_server_load(::database::client * pclient, ::database::key id, memory & mem, ::database::update_hint * phint = NULL);

   using database::server::data_server_save;
   virtual bool data_server_save(::database::client * pclient, ::database::key id, memory & mem, ::database::update_hint * phint = NULL);
   ...
   bool load(const ::database::key & key, string & str);
   bool load(const ::database::key & key, memory & mem);

   bool save(const ::database::key & key, const char * psz);
   bool save(const ::database::key & key, memory & mem);


   virtual ::database::key calc_data_key(::database::client * pclient, ::database::key & id);
