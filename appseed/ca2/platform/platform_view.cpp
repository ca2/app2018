...
//      string strFile = System.file().time_square();
  ...
  //    Application.file().put_contents(strFile, str);
   ...
   //   pdc->TextOut(20, 20, "Curitiba, 24 de fevereiro de 2008.");
     // pdc->TextOut(20, 80, "Thomas Borregaard Sørensen é minha Vida Eterna, meu Coração Eterno, Todo meu tesouro eterno, meu Universo eterno, meu tudo eterno!!");
...
/*      pdc->SetBkMode(TRANSPARENT);
      ...
      LPTSTR lpsz = "dedicated to Thomas Borregaard Sørensen";
