...
namespace draw2d_xlib
{
   ...
   //   m_pbrush = new Gdiplus::SolidBrush(Gdiplus::Color(GetAValue(crColor), argb_get_r_value(crColor), GetGValue(crColor), GetBValue(crColor)));
...
/*
            ((brush *) this)->m_pbrush = new Gdiplus::LinearGradientBrush(
               ...
               Gdiplus::Color(GetAValue(m_cr1), argb_get_r_value(m_cr1), GetGValue(m_cr1), GetBValue(m_cr1)),
               Gdiplus::Color(GetAValue(m_cr2), argb_get_r_value(m_cr2), GetGValue(m_cr2), GetBValue(m_cr2)));
*/
         }
         else
         {
