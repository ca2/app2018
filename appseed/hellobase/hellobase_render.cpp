...
namespace hellobase
{
   ...
   void render::helloaura_render()
   {

      {
         ...
         helloaura_render(pdib->get_graphics());
   ...
   void render::helloaura_render(::draw2d::graphics * pgraphics)
   {
      ...
      //   {
      //
      //      helloaura_render_full_view(pdib->get_graphics());
      //
      //   }
...
//      }
   ...
   void render::_001OnHelloDraw(::draw2d::graphics * pgraphics)
   {
      ...
      return ::helloaura::render::_001OnHelloDraw(pgraphics);
