...
bool UpdateDnsBkApp::initialize_instance()
{
   ...
   try
   {
      ...
      if(command().m_varTopicQuery.has_property("console"))
      {
      ...
      else if(command().m_varTopicQuery.has_property("remove"))
      {
         RemoveService();
         return FALSE;
      }
...
int UpdateDnsBkApp::CreateService()
{
   ...
   SC_HANDLE hdlServ = ::CreateService(
      ...
      "TBSCSTvotagusCa2FontopusMainUpdateDnsBk",               // name of service 
