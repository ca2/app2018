...
namespace tesseract
{
   ...
   void list::install_message_handling(::user::win::message::dispatch * pinterface)
   {
      ...
      ::mail::list_interface::install_message_handling(pinterface);
   ...
   void list::open_folder(const char * pszFolder)
   {
      ...
      if(strFolder.is_empty())
         return;
      single_lock slDataset(&get_document()->m_paccount->m_pop3.m_csDataset, TRUE);
      _001OnUpdateItemCount();
