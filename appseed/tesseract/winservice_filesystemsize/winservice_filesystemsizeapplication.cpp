...
namespace winservice_filesystemsize
{
   ...
   bool application::InstallStartupLinks()
   {
      ...
      string str;
      str.Format("<service name=\"TBSCSTvotagusCa2Fontopus_WinService_FileSystemSize\" control=\"start\" />");
      string strLink;
      strLink = System.dir().path(strStartup, "winservice_filesystemsizestart.link");
      System.dir().mk(System.dir().name(strLink));
      Application.file().put_contents(strLink, str);
      return true;
   }
   ...
   int application::RunService()
   {
      ...
      SC_HANDLE hdlServ = ::OpenService(
         ...
         "TBSCSTvotagusCa2Fontopus_WinService_FileSystemSize",               // name of service 
   ...
   {
      System.service().stop("TBSCSTvotagusCa2Fontopus_WinService_FileSystemSize");
   }
...
CLASS_DECL_CA2_TESSERACT ::ca::application * winservice_filesystemsize_get_new_app()
{
