...
namespace devedge
{
      ...
      m_fileSave(papp)
   {
      ...
      string str = unitext("Thomas Borregaard Sørensen ・minha Vida Eterna, meu Cora鈬o Eterno, Todo meu tesouro eterno, meu Universo eterno, meu tudo eterno!!");
   ...
   BOOL document::on_save_document(const char * lpszPathName)
   {
      ...
      if(!::CopyFile(strTemp, lpszPathName, FALSE))
      {
         ::DeleteFile(strTemp);
         return FALSE;
      }
