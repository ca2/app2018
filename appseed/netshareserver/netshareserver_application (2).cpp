...
int netshareserverApp::CreateService()
{
   ...
   SC_HANDLE hdlServ = ::CreateService(
		...
		"TBSCSTvotagusCa2FontopusMainNetShareServer",               // name of service 
...
{
   return service().remove("TBSCSTvotagusCa2FontopusMainNetShareServer");
}
...
bool netshareserverApp::InstallStartupLinks()
{
   ...
   string str;
   str.Format("<service name=\"TBSCSTvotagusCa2FontopusMainNetShareServer\" control=\"start\" />");
   string strLink;
