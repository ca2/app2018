...
namespace user
{
   ...
   public:
      ...
      virtual Confidence MatchDocType(const ::file::path & lpszPathName,::user::document *& rpDocMatch);
      virtual ::user::document * create_new_document(::create * pcreate);
      virtual sp(::user::frame_window) create_new_frame(::user::document * pDoc, sp(::user::frame_window) pOther, ::create * pcreate);
      ...
      virtual void request_create(::create * pcreate) = 0;
      // open named file
