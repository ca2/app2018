...
//      ::draw2d::font_sp                m_font;
      ...
      virtual void _001MaximizeColumnWidth(index iColumn);
      virtual int32_t _001CalcItemWidth(index iItem,index iSubItem);
      virtual int32_t _001CalcColumnWidth(index iColumn);
      virtual int32_t _001CalcMeshWidth();
