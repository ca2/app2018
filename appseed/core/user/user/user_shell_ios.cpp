...
namespace user
{
   ...
   namespace shell
   {
      ...
      int32_t ios::get_image_by_extension(per_fork * pfork, oswindow oswindow, image_key & key, COLORREF crBk)
      {
...
//      int32_t ios::get_image(per_fork * pfork, oswindow oswindow, image_key imagekey, LPITEMIDLIST lpiidlAbsolute, LPITEMIDLIST lpiidlChild, const unichar * lpcszExtra, COLORREF crBk)
//      {
//
...
//                     string strIcon;
//
//                     strIcon = ::dir::system() / "config/ios/app_theme" / m_strShellThemePrefix + strExtension + ".ico";
//
...
//      }
      ...
      int32_t ios::get_foo_image(per_fork * pfork, oswindow oswindow, image_key imagekey, COLORREF crBk)
      {
...
//         }         synch_lock sl(m_pmutex);
      ...
      //int32_t ios::get_image(per_fork * pfork, oswindow oswindow, image_key imagekey, LPITEMIDLIST lpiidlAbsolute, const unichar * lpcszExtra, COLORREF crBk)
      //{
...
//
      ...
      e_folder ios::get_folder_type(::aura::application * papp, const char * lpcsz)
      {
      ...
      e_folder ios::get_folder_type(::aura::application * papp, const unichar * lpcszPath)
      {
      ...
      int32_t ios::get_image(per_fork * pfork, oswindow oswindow, image_key imagekey, const unichar * lpcszExtra, COLORREF crBk)
      {
...
//            }
         ...
         if (ios_get_file_image(dib48, strPath))
         {
            ...
            if (ios_get_file_image(dib16, strPath))
            {
...
//         SHGetMalloc(&m_pmalloc);
      ...
      int32_t ios::get_image_foo(oswindow oswindow, const string & strExtension, e_file_attribute eattribute, e_icon eicon, COLORREF crBk)
      {
...

         {
            ...
            imagekey.m_pszPath = (char *) (const char *) "foo";
