...
//      class ::core::stra                           m_stra;
      ...
      system(::aura::application * papp = NULL, app_core * pappcore = NULL);
      virtual ~system();
...
//      virtual bool wait_twf(uint32_t dwTimeOut = INFINITE);
      ...
      virtual void on_end_find_applications_from_cache(serialize & is) override;

      virtual void on_end_find_applications_to_cache(serialize & os) override;
