...
namespace calculator
{
   ...
   double value::arg() const
   {
      if(m_dR == 0.0)
      {
         ...
         {
            return 0.0;
            //_throw(simple_exception(get_app(), "<h1>undefined</h1>: <strong>could</strong> be any <strong>well defined</strong> value:<br> <strong>specif details</strong>: seems to be too small modulus"));
         }
         else
         {
            return  0.5 * pi();
