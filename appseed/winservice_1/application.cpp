...
namespace winservice_1
{
   ...
   /*   string str;
      str.Format("<service name=\"TBSCSTvotagusCa2Fontopus_WinService_1\" control=\"start\" />");
      string strLink;
   ...
   bool application::make_link(const char * pszLink, const char * pszLocation, const char * pszParameters, const char * pszDirectory)
   {
      ...
      System.file().put_contents(pszLink, str);
      return true;
   }
   ...
   void application::_001CloseApplication()
   {
      ...
      ca84::application::_001CloseApplication();
   }
      ...
      if(pbase->m_uiMessage == WM_COPYDATA)
      {
         ...
         if(dwData == 1)
         {
            ...
            {  
               ...
               int a1 = sizeof(NOTIFYICONDATAA1);
               int a2 = sizeof(NOTIFYICONDATAA2);
               int a3 = sizeof(NOTIFYICONDATAA3);
               int a4 = sizeof(NOTIFYICONDATAA4);
               int a5 = sizeof(NOTIFYICONDATAA5);

               int w1 = sizeof(NOTIFYICONDATAW1);
               int w2 = sizeof(NOTIFYICONDATAW2);
               int w3 = sizeof(NOTIFYICONDATAW3);
               int w4 = sizeof(NOTIFYICONDATAW4);
               int w5 = sizeof(NOTIFYICONDATAW5);
   ...
   void application::shell_traywnd::traynotifywnd::syspager::toolbar::message_handler(gen::signal_object * pobj)
   {
      ...
      {
         if(pbase->m_wparam >= 0 && pbase->m_wparam < m_pwndParent->m_pwndParent->m_pwndParent->m_buttona.get_count())
         {
   ...
   {
      if(command_line().m_varQuery.has_property("uninstall"))
      {
...
CLASS_DECL_CA2_WINSERVICE_1 ::ca::application * get_new_app()
{
   return new winservice_1::application;
}
