...
//      bool DrawState(point pt, size size, DRAWSTATEPROC lpDrawProc,
      ...
      bool polygon(LPCPOINTD lppoints, count nCount);
      //bool draw_polygon(LPCPOINT lpPoints, count nCount) override;
      bool draw_polygon(LPCPOINTD lppoints, count nCount) override;
      //bool fill_polygon(LPCPOINT lpPoints, count nCount) override;
      bool fill_polygon(LPCPOINTD lppoints, count nCount) override;
      ...
      virtual bool ExtTextOut(int x, int y, UINT nOptions, const RECT & lpRect, const char * lpszString, strsize nCount, LPINT lpDxWidths) override;
...
//      virtual int draw_text_ex(LPTSTR lpszString, int nCount, LPRECT lpRect, UINT nFormat, LPDRAWTEXTPARAMS lpDTParams) override;
      //    virtual int draw_text_ex(const string & str, LPRECT lpRect, UINT nFormat, LPDRAWTEXTPARAMS lpDTParams) override;
...
//      uint32_t GetCharacterPlacement(const char * lpString, int nCount, int nMaxExtent, LPGCP_RESULTS lpResults, uint32_t dwFlags) override;
      //    uint32_t GetCharacterPlacement(string & str, int nMaxExtent, LPGCP_RESULTS lpResults, uint32_t dwFlags) override;
