...
namespace draw2d_direct2d
{
   ...
   CLASS_DECL_DRAW2D_DIRECT2D void dib::s_initialize()
   {
      double dCos;
      double dSin;
      double d32 = (1U << 31);
...
fill_last:
   ...
   void dib::unmap()
   {
      ...
      HRESULT hr = ((ID2D1Bitmap *) m_spbitmap->get_os_data())->CopyFromMemory(&srcRect, m_pcolorref, scan);
...
#define new DEBUG_NEW
   ...
   bool dib::print_window(::ca2::window * pwnd, signal_details * pobj)
   {
      ...
      try
      {
         ...
         m_spgraphics->TextOut(0, 0, "Te Amo TBS", 11);
      }
      catch(...)
      {
      }
