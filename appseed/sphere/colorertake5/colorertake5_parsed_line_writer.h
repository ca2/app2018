...
namespace colorertake5
{
   ...
   */
   ...
   public:
      ...
      */
      static void tokenWrite(serialize & markupWriter, serialize & textWriter, string_to_string * docLinkHash, const char  *line, LineRegion *lineRegions);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      static void markupWrite(serialize & markupWriter, serialize & textWriter, string_to_string *docLinkHash, const char *line, LineRegion *lineRegions);
      ...
      @param lineRegions Linked list of LineRegion structures
      */
      static void htmlRGBWrite(serialize & markupWriter, serialize & textWriter, string_to_string *docLinkHash, const char *line, LineRegion *lineRegions);

      static void writeStyle(serialize & writer, const StyledRegion *lr);

      /** Puts into stream starting HTML \<span> tag with requested style specification
      */
      static void writeStart(serialize & writer, const StyledRegion *lr);

      /** Puts into stream ending HTML \</span> tag
      */
      static void writeEnd(serialize & writer, const StyledRegion *lr);

      static void writeHref(serialize & writer, string_to_string *docLinkHash, const class scheme *scheme, const string &token, bool start);
