   ...
   */
   ...
   public:
      ...
      */
      ...
      base_editor(::aura::application * papp);
      ~base_editor();
      ...
      */
      ...
      /**
      * Tries to do some parsing job while ::fontopus::user is doing nothing.
   ...
   private:
      ...
      pointer_array < RegionHandler * > regionHandlers;
      pointer_array < EditorListener * > editorListeners;
      ...
      inline index getLastVisibleLine();
