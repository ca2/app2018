...
namespace hi5
{
   ...
   public:
      ...
      twit(::aura::application * papp, simple_log * psimplelog = NULL, index iLogTarget = -1);
      virtual ~twit();
      ...
      /* Twitter status APIs */
      bool statusUpdate(string & newStatus /* in */, stringa straMediaIds = {}, string strReplyStatusId = "");
