...
void syllomatter_view::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
{
...
//   pdc->TextOut(20, 20, "Curitiba, 24 de fevereiro de 2008.");
  // pdc->TextOut(20, 80, "Thomas Borregaard SÃ¸rensen é minha Vida Eterna, meu Coração Eterno, Todo meu tesouro eterno, meu Universo eterno, meu tudo eterno!!");
...
{
   stringa straPath;
   ca77::application * papp = &App(pextract->get_app());
   stringa straRepos;
