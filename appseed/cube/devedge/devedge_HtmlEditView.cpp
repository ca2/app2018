...
void devedgeHtmlEditView::_001InstallMessageHandling(::user::win::message::dispatch * pinterface)
{
...
void devedgeHtmlEditView::transform()
{
   ...
   string strImgNns = System.dir().matter("html_edit_nns.png");
   ...
   System.file().put_contents(strDestPath, strDest);
   */
...
//   SaveAs(strSourcePath);
   ...
   System.file().put_contents(strDestPath, str);
