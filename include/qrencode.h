 ...
 * @_throw( ENOMEM unable to allocate memory.
 */
 ...
 * @return an input object (initialized). On error, NULL is returned and errno
 *         is set to indicate the error.
 * @_throw( ENOMEM unable to allocate memory for input objects.
 * @_throw( EINVAL invalid arguments.
 */
 ...
 * @_throw( ENOMEM unable to allocate memory.
 * @_throw( EINVAL input data is invalid.
 *
 */
 ...
 * @_throw( ERANGE input data is too large.
 * @_throw( EINVAL invalid input data.
 * @_throw( ENOMEM unable to allocate memory.
 */
 ...
 * @retval -1 an error occurred and errno is set to indeicate the error.
 *            See Execptions for the details.
 * @_throw( EINVAL invalid input object.
 * @_throw( ENOMEM unable to allocate memory.
 */
