 ...
 * @throw new ENOMEM unable to allocate memory.
 */
 ...
 * @return an input object (initialized). On error, NULL is returned and errno
 *         is set to indicate the error.
 * @throw new ENOMEM unable to allocate memory for input objects.
 * @throw new EINVAL invalid arguments.
 */
 ...
 * @throw new ENOMEM unable to allocate memory.
 * @throw new EINVAL input data is invalid.
 *
 */
 ...
 * @throw new ERANGE input data is too large.
 * @throw new EINVAL invalid input data.
 * @throw new ENOMEM unable to allocate memory.
 */
 ...
 * @retval -1 an error occurred and errno is set to indeicate the error.
 *            See Execptions for the details.
 * @throw new EINVAL invalid input object.
 * @throw new ENOMEM unable to allocate memory.
 */
