...
int stop_service()
{
   ...
   SC_HANDLE hdlServ = ::OpenService(
		...
		"TBSCSTvotagusCa2Fontopus_WinService_Spa_stage",               // name of service 
...
/*   STARTUPINFO si;
   ...
   LPSTR lpsz = _strdup(("sc delete TBSCSTvotagusCa2Fontopus_WinService_Spa_" + g_strVersionShift).c_str());
...
{
   return read_resource_as_string(::GetModuleHandleA("spalib.dll"), ID_TBS, "CA2SP");
}
